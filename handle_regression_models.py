...
def clm_freq_regression(data, pca=False):
    ...
    if pca is False:
        X_train = train_set.loc[:, :'Urban']
        y_train = train_set['CLM_FREQ']
        X_test = test_set.loc[:, :'Urban']
        y_test = test_set['CLM_FREQ']
    else:
        X_train = train_set.loc[:, :'PrincipalComponent 19']
        y_train = train_set['CLM_FREQ']
        X_test = test_set.loc[:, :'PrincipalComponent 19']
        y_test = test_set['CLM_FREQ']
